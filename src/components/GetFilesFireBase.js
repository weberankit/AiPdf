...
//  console.log(item,item._location.path )
 ...
 // console.log(textFileidentify)
  return(
  <>
  <div key={textFileidentify+Date.now()+9} className="p-4 flex flex-row justify-between">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="#ff0000" d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM112 256H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H272c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
...

 {
              ...
              textFileidentify !== "txt" &&  <button className=" bg-orange-600 hover:bg-yellow-500 text-black p-1 rounded-lg m-1 animate-pulse duration-1000 hover:animate-none"  onClick={()=>{handlePdf(item._location.path,setProUrl) ;
...
<div className="w-1/2" >
            ...
            <div >
             ...
             { 
                   textFileidentify==="txt"?<button className="bg-green-500 text-white rounded-lg m-1 p-1 hover:bg-black" onClick={()=>{handleText(item._location.path);setUrl(null);setProUrl(null);handleReachTop(0)}}>open text file</button> :  
                   <button className="bg-gray-600 text-white rounded-lg m-1 p-1 hover:bg-black" onClick={()=>{ handlePdf(item._location.path ,setUrl);   handleReachTop(0);setProUrl(null) ;  dispatch(textFile(null))}}>  Simple pdf viewer</button>
