...
<div  className={`z-[100] text-md  text-white md:flex w-2/3  bg-red-600  justify-between p-2 items-center md:flex-row  ${navIcon ? "flex flex-col fixed top-0  left-0 h-48 " : "hidden"} `} >
